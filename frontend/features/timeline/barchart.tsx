...
import { DayBin } from "./timeline-wrapper";
...
const Barchart = ({ data }: BarchartProps) => {
    ...
    useEffect(() => {
        ...
        var nxExtent = [d3.timeDay.offset(xExtent[0] as Date, -1), d3.timeDay.offset(xExtent[1] as Date, 1)];
        ...
        // add the axes
        const xAxis = d3.axisBottom(scaleOrdinal)
